...
namespace Figure
{
	...
	*****************************************************************************************************/
	...
	@@ return bool : 충돌 여부
	*****************************************************************************************************/
	inline bool IsCollisionRevise(FloatRect* const rcMove, const FloatRect* const rcHold)
	{
		FloatRect rcInter;
	...
	*****************************************************************************************************/
	...
	렉트를 x, y 값만큼 이동 시킨다
	*****************************************************************************************************/
	inline void MoveFloatRect(Figure::FloatRect* rc, float x, float y) 
	{
		//렉트 left / right 은 x 보정을, top / bottom 은 y 보정 이동을 해준다 
		rc->left += x;
		rc->right += x;
		rc->top += y;
		rc->bottom += y;
